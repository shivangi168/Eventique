    ...
    <header className="fixed top-0 w-full z-50 bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 font-bold text-xl">
          <div className="bg-green-500 text-white w-8 h-8 flex items-center justify-center rounded-full">B</div>
          <span>Barren</span>
        </div>
          ...
          <div ref={dropdownRefs.events} className="relative">
            ...
            {openDropdown === "events" && (
              <div className="absolute top-full left-0 mt-2 bg-white shadow-lg border rounded w-52">
                <a href="#" className="block px-4 py-2 hover:bg-gray-100">Explore Events</a>
          ...
          <div ref={dropdownRefs.pages} className="relative">
            ...
            {openDropdown === "pages" && (
              <div className="absolute top-full left-0 mt-2 bg-white shadow-lg border rounded w-40">
                ...
                <a href="#" className="block px-4 py-2 hover:bg-gray-100">Terms</a>
              </div>
            )}
          </div>
        </nav>
