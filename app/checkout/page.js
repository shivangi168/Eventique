...
export default function Checkout({ onLogout, onExploreEvents, onCreateEvent, onCreateVenue, event, ticketQuantity, onLogin, onSignUp, onBackToEvent, onNavigateToPricing }) {
  return (
    <div>
